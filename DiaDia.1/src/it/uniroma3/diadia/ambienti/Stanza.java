...
public class Stanza {
	...
	public List<Attrezzo> getAttrezzi() {
		Collection<Attrezzo> k = this.nome2attrezzo.values();
		List<Attrezzo> a = new ArrayList<Attrezzo>(k);
		return a;
	}
	...
	public boolean isMagica(Stanza s) {
		return s instanceof StanzaMagica;
	}
}