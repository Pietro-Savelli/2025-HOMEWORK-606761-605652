...
public class Stanza {
	...
	*/
	...
	public Attrezzo getAttrezzo(String nomeAttrezzo) {
		...
		for (Attrezzo attrezzo : this.attrezzi) {
			if (attrezzo!= null && attrezzo.getNome().equals(nomeAttrezzo)) // aggiunto il controllo che (attrezzo !=null)
	 ...
	 * @param attrezzo nome dell'attrezzo da eliminare
	...
	/**
	 * 
	 * @return un array di stringhe contenente le direzioni delle stanze adiacenti.
	 */
